...
specific architecture, a simple dense model in this case
"""
...
def basic_conv_model(input_shape, num_kernels, kernel_sizes,
            pool_sizes, pool_strides,
            num_hidden_units,
            num_classes):
    """Defines a simple 2 layer convolution model in keras.
